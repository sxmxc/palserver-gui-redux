...
export async function generateMetadata({
  ...
  return {
    ...
    authors: [{ name: 'Eason Lu (Dalufish)', url: 'https://github.com/sxmxc/palserver-gui-redux' }],
    creator: 'io software',
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        sameAs: ['https://github.com/io-software-ai', 'https://github.com/sxmxc/palserver-gui-redux'],
      },
      {
        '@type': 'WebSite',
        '@id': `${SITE_URL}/#site`,
