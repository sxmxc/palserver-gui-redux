...
| `PALSERVER_GITHUB_REPO` | `sxmxc/palserver-gui-redux` | 自我更新要看哪個 repo 的 Releases |
...
**v2 目前版本為 v2.1.0**,已可直接到 [Releases](https://github.com/sxmxc/palserver-gui-redux/releases) 下載使用,
上面列的功能都已經上線。
